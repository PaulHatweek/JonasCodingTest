...
namespace WebApi.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IDbWrapper<Company>>().To<InMemoryDatabase<Company>>().InSingletonScope();
            kernel.Bind<IDbWrapper<Employee>>().To<InMemoryDatabase<Employee>>().InSingletonScope();
        }
    }
}